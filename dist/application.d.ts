...
declare const FoodMarketplaceApplication_base: (new (...args: any[]) => {
    projectRoot: string;
    ...
    expressMiddleware(key: import("@loopback/core").BindingAddress, middleware: import("@loopback/rest").ExpressRequestHandler | import("@loopback/rest").ExpressRequestHandler[], options?: import("@loopback/rest").MiddlewareBindingOptions | undefined): import("@loopback/boot").Binding<import("@loopback/rest").Middleware>;
    expressMiddleware<CFG>(middlewareFactory: import("@loopback/rest").ExpressMiddlewareFactory<CFG>, middlewareConfig?: CFG | undefined, options?: import("@loopback/rest").MiddlewareBindingOptions | undefined): import("@loopback/boot").Binding<import("@loopback/rest").Middleware>;
    expressMiddleware<CFG_1>(factoryOrKey: import("@loopback/core").BindingAddress<import("@loopback/rest").Middleware> | import("@loopback/rest").ExpressMiddlewareFactory<CFG_1>, configOrHandler: import("@loopback/rest").ExpressRequestHandler | CFG_1 | import("@loopback/rest").ExpressRequestHandler[], options?: import("@loopback/rest").MiddlewareBindingOptions | undefined): import("@loopback/boot").Binding<import("@loopback/rest").Middleware>;
    middleware(middleware: import("@loopback/rest").Middleware | import("@loopback/core").Constructor<import("@loopback/core").Provider<import("@loopback/rest").Middleware>>, options?: import("@loopback/rest").MiddlewareBindingOptions | undefined): import("@loopback/boot").Binding<import("@loopback/rest").Middleware>;
    readonly name: string;
    readonly subscriptionManager: import("@loopback/core").ContextSubscriptionManager;
    scope: import("@loopback/core").BindingScope;
    readonly parent: import("@loopback/core").Context | undefined;
    emitEvent: <T_10 extends import("@loopback/core").ContextEvent>(type: string, event: T_10) => void;
    emitError: (err: unknown) => void;
    bind: <ValueType_12 = any>(key: import("@loopback/core").BindingAddress<ValueType_12>) => import("@loopback/boot").Binding<ValueType_12>;
    add: (binding: import("@loopback/boot").Binding<unknown>) => import("@loopback/core").Context;
    configure: <ConfigValueType_6 = any>(key?: import("@loopback/core").BindingAddress | undefined) => import("@loopback/boot").Binding<ConfigValueType_6>;
    getConfigAsValueOrPromise: <ConfigValueType_1_3>(key: import("@loopback/core").BindingAddress, propertyPath?: string | undefined, resolutionOptions?: import("@loopback/core").ResolutionOptions | undefined) => import("@loopback/core").ValueOrPromise<ConfigValueType_1_3 | undefined>;
    getConfig: <ConfigValueType_2_3>(key: import("@loopback/core").BindingAddress, propertyPath?: string | undefined, resolutionOptions?: import("@loopback/core").ResolutionOptions | undefined) => Promise<ConfigValueType_2_3 | undefined>;
    getConfigSync: <ConfigValueType_3_3>(key: import("@loopback/core").BindingAddress, propertyPath?: string | undefined, resolutionOptions?: import("@loopback/core").ResolutionOptions | undefined) => ConfigValueType_3_3 | undefined;
    unbind: (key: import("@loopback/core").BindingAddress) => boolean;
    subscribe: (observer: import("@loopback/core").ContextEventObserver) => import("@loopback/core").Subscription;
    unsubscribe: (observer: import("@loopback/core").ContextEventObserver) => boolean;
    close: () => void;
    isSubscribed: (observer: import("@loopback/core").ContextObserver) => boolean;
    createView: <T_1_3 = unknown>(filter: import("@loopback/core").BindingFilter, comparator?: import("@loopback/core").BindingComparator | undefined, options?: Omit<import("@loopback/core").ResolutionOptions, "session"> | undefined) => import("@loopback/core").ContextView<T_1_3>;
    contains: (key: import("@loopback/core").BindingAddress) => boolean;
    isBound: (key: import("@loopback/core").BindingAddress) => boolean;
    getOwnerContext: (keyOrBinding: import("@loopback/core").BindingAddress | Readonly<import("@loopback/boot").Binding<unknown>>) => import("@loopback/core").Context | undefined;
    getScopedContext: (scope: import("@loopback/core").BindingScope.APPLICATION | import("@loopback/core").BindingScope.SERVER | import("@loopback/core").BindingScope.REQUEST) => import("@loopback/core").Context | undefined;
    getResolutionContext: (binding: Readonly<import("@loopback/boot").Binding<unknown>>) => import("@loopback/core").Context | undefined;
    isVisibleTo: (ctx: import("@loopback/core").Context) => boolean;
    find: <ValueType_1_3 = any>(pattern?: string | RegExp | import("@loopback/core").BindingFilter | undefined) => Readonly<import("@loopback/boot").Binding<ValueType_1_3>>[];
    findByTag: <ValueType_2_3 = any>(tagFilter: RegExp | import("@loopback/core").BindingTag) => Readonly<import("@loopback/boot").Binding<ValueType_2_3>>[];
    get: {
        <ValueType_3_3>(keyWithPath: import("@loopback/core").BindingAddress<ValueType_3_3>, session?: import("@loopback/core").ResolutionSession | undefined): Promise<ValueType_3_3>;
        <ValueType_4_3>(keyWithPath: import("@loopback/core").BindingAddress<ValueType_4_3>, options: import("@loopback/core").ResolutionOptions): Promise<ValueType_4_3 | undefined>;
    };
    getSync: {
        <ValueType_5_3>(keyWithPath: import("@loopback/core").BindingAddress<ValueType_5_3>, session?: import("@loopback/core").ResolutionSession | undefined): ValueType_5_3;
        <ValueType_6_3>(keyWithPath: import("@loopback/core").BindingAddress<ValueType_6_3>, options?: import("@loopback/core").ResolutionOptions | undefined): ValueType_6_3 | undefined;
    };
    getBinding: {
        <ValueType_7_3 = any>(key: import("@loopback/core").BindingAddress<ValueType_7_3>): import("@loopback/boot").Binding<ValueType_7_3>;
        <ValueType_8_3>(key: import("@loopback/core").BindingAddress<ValueType_8_3>, options?: {
            optional?: boolean | undefined;
        } | undefined): import("@loopback/boot").Binding<ValueType_8_3> | undefined;
    };
    findOrCreateBinding: <T_2_3>(key: import("@loopback/core").BindingAddress<T_2_3>, policy?: import("@loopback/core").BindingCreationPolicy | undefined) => import("@loopback/boot").Binding<T_2_3>;
    getValueOrPromise: <ValueType_9_3>(keyWithPath: import("@loopback/core").BindingAddress<ValueType_9_3>, optionsOrSession?: import("@loopback/core").ResolutionOptionsOrSession | undefined) => import("@loopback/core").ValueOrPromise<ValueType_9_3 | undefined>;
    toJSON: () => import("@loopback/core").JSONObject;
    inspect: (options?: import("@loopback/core").ContextInspectOptions | undefined) => import("@loopback/core").JSONObject;
    on: {
        (eventName: "bind" | "unbind", listener: import("@loopback/core").ContextEventListener): import("@loopback/core").Context;
        (event: string | symbol, listener: (...args: any[]) => void): import("@loopback/core").Context;
    };
    once: {
        (eventName: "bind" | "unbind", listener: import("@loopback/core").ContextEventListener): import("@loopback/core").Context;
        (event: string | symbol, listener: (...args: any[]) => void): import("@loopback/core").Context;
    };
    addListener: <K_1_3>(eventName: string | symbol, listener: (...args: any[]) => void) => import("@loopback/core").Context;
    removeListener: <K_2_3>(eventName: string | symbol, listener: (...args: any[]) => void) => import("@loopback/core").Context;
    off: <K_3_3>(eventName: string | symbol, listener: (...args: any[]) => void) => import("@loopback/core").Context;
    removeAllListeners: (event?: string | symbol | undefined) => import("@loopback/core").Context;
    setMaxListeners: (n: number) => import("@loopback/core").Context;
    getMaxListeners: () => number;
    listeners: <K_4_3>(eventName: string | symbol) => Function[];
    rawListeners: <K_5_3>(eventName: string | symbol) => Function[];
    emit: <K_6_3>(eventName: string | symbol, ...args: any[]) => boolean;
    listenerCount: <K_7_3>(eventName: string | symbol, listener?: Function | undefined) => number;
    prependListener: <K_8_3>(eventName: string | symbol, listener: (...args: any[]) => void) => import("@loopback/core").Context;
    prependOnceListener: <K_9_3>(eventName: string | symbol, listener: (...args: any[]) => void) => import("@loopback/core").Context;
    eventNames: () => (string | symbol)[];
}) & typeof RestApplication;
export declare class FoodMarketplaceApplication extends FoodMarketplaceApplication_base {
